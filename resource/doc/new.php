...
try {
    ...
    $doc = new Document();
    $doc->setKnowledgeBase($data->knowledge_base);
    $doc->setFolder($data->folder);
    ...
    $register = new Register($user->getId(), date('Y-m-d h:i:s'), 'Create Document');
    ...
    $doc = $docService->create($doc, $register);
    ...
    echo json_encode(array(
        ...
        'message' => 'You can watch it right now',
        'success' => true
    ));
} catch (Exception $e) {
    $conn->rollBack();
